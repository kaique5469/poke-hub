...
function cached<T>(
  ...
  return fn().then(d => {
    cache.set(key, { data: d, expires: Date.now() + ttlMs });
    return d;
  });
}
...
const FALLBACK_META_DECKS: MetaDeck[] = [
  {
    ...
    sharePercent: 49.22,
    points: 2227,
    imageUrl: "https://images.pokemontcg.io/sv4/130_hires.png",
    topFinish: "1st Place NAIC 2026",
  },
  {
    rank: 2,
    slug: "zoroark",
    ...
    sharePercent: 8.02,
    points: 363,
    imageUrl: "https://images.pokemontcg.io/sv5/125_hires.png",
    topFinish: "14th Place NAIC 2026",
  },
  {
    rank: 3,
    slug: "crustle",
    ...
    sharePercent: 6.14,
    points: 278,
    imageUrl: "https://images.pokemontcg.io/sv7/107_hires.png",
    topFinish: "5th Place NAIC 2026",
  },
  {
    rank: 4,
    slug: "slowking",
    ...
    topFinish: "2nd Place Special Event Turin",
  },
  {
    rank: 5,
    slug: "hydrapple",
    ...
    sharePercent: 4.84,
    points: 219,
    imageUrl: "https://images.pokemontcg.io/sv6/14_hires.png",
    topFinish: "5th Place NAIC 2026",
  },
  {
    rank: 6,
  ...
  },
  {
    ...
    sharePercent: 3.51,
    points: 159,
    imageUrl: "https://images.pokemontcg.io/sv6/49_hires.png",
    topFinish: "Top 8 NAIC 2026",
  },
  {
    rank: 8,
    slug: "ogerpon",
    ...
    sharePercent: 3.18,
    points: 144,
    imageUrl: "https://images.pokemontcg.io/sv6/26_hires.png",
    topFinish: "Top 8 NAIC 2026",
  },
  {
    rank: 9,
  ...
  },
  {
    ...
    sharePercent: 2.14,
    points: 97,
    imageUrl: "https://images.pokemontcg.io/sv4/121_hires.png",
    topFinish: "Top 16 NAIC 2026",
  },
  {
    rank: 11,
    ...
    sharePercent: 1.61,
    points: 73,
    imageUrl: "https://images.pokemontcg.io/sv6pt5/6_hires.png",
    topFinish: "Top 32 NAIC 2026",
  },
  {
    rank: 12,
    slug: "lucario-mega",
    ...
    sharePercent: 1.46,
    points: 66,
    imageUrl: "https://images.pokemontcg.io/me1/188_hires.png",
    topFinish: "Top 32 NAIC 2026",
  },
];
...
const FALLBACK_TOURNAMENTS: Tournament[] = [
  ...
  },
  {
    ...
    format: "standard",
    players: 2150,
    winner: "Miloslav Posledni",
    winnerCountry: "CZ",
    type: "regional",
  },
  {
    id: "regional-campinas",
    name: "Regional Campinas",
    date: "2026-05-16",
    country: "BR",
    format: "standard",
    players: 1725,
    winner: "Matias Matricardi",
    winnerCountry: "AR",
    type: "regional",
  },
  {
  ...
  {
    id: "regional-prague",
    name: "Regional Prague",
    date: "2026-04-25",
    country: "CZ",
    format: "standard",
    players: 1370,
    winner: "Mateusz Łaszkiewicz",
    winnerCountry: "PL",
    type: "regional",
  },
  {
    id: "regional-orlando",
    name: "Regional Orlando, FL",
    date: "2026-04-04",
    country: "US",
    format: "standard",
    players: 2745,
    winner: "Noah Sakadjian",
    winnerCountry: "US",
    type: "regional",
  },
  {
    id: "regional-houston",
    name: "Regional Houston, TX",
    date: "2026-03-21",
    country: "US",
    format: "standard",
    players: 2635,
    winner: "Yoshiyuki Yamaguchi",
    winnerCountry: "JP",
    type: "regional",
  },
];
  ...
  return cached(`meta:${format}`, TTL_META, async () => {
    try {
      const res = await fetch(`${BASE}/decks?format=${format}`, {
        headers: { "User-Agent": "RarityGrid/1.0" },
      });
