...
const PokeballIcon = ({
  ...
  >
    ...
    <path
      d="M1 12C1 6.477 5.477 2 11 2"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
    <path
      d="M13 2C18.523 2 23 6.477 23 12"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
...
const navSections = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/bazaar",
        icon: <Heart size={16} />,
        desc: "Cards you want to buy",
      },
      {
        label: "Auctions",
        href: "/auctions",
        icon: <Zap size={16} />,
        desc: "Live card auctions",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        desc: "Complete Pokédex",
      },
      {
        label: "By Type",
        href: "/pokedex?view=type",
        icon: <Shield size={16} />,
        desc: "Filter by element type",
      },
      {
        label: "By Region",
        href: "/pokedex?view=gen",
        icon: <Star size={16} />,
        desc: "Kanto, Johto, Hoenn...",
      },
    ],
  },
  {
    ...
    items: [
      {
        label: "Booster Boxes",
        href: "/shop?cat=booster_box",
        icon: <Package size={16} />,
        desc: "Sealed booster boxes",
      },
      {
        label: "Elite Trainer Boxes",
        href: "/shop?cat=etb",
        icon: <Package size={16} />,
        desc: "ETBs & special sets",
      },
      {
        label: "Tins & Blisters",
        href: "/shop?cat=tin",
        icon: <Package size={16} />,
        desc: "Tins, blisters & packs",
      },
      {
        label: "Booster Packs",
        href: "/shop?cat=booster_pack",
        icon: <Package size={16} />,
        desc: "Single packs & blisters",
      },
      {
        label: "Collector Boxes",
        href: "/shop?cat=collector_box",
        icon: <Package size={16} />,
  ...
  },
  {
    ...
    items: [
      {
        label: "Playmats",
        href: "/shop?cat=playmat",
        icon: <Wrench size={16} />,
        desc: "Tournament playmats",
      },
      {
        label: "Sleeves",
        href: "/shop?cat=sleeves",
        icon: <Wrench size={16} />,
        desc: "Card sleeves & protectors",
      },
      {
        label: "Deck Boxes",
        href: "/shop?cat=deck_box",
        icon: <Wrench size={16} />,
        desc: "Storage & deck boxes",
      },
      {
        label: "Binders & Portfolios",
        href: "/shop?cat=binder_portfolio",
        icon: <BinderIcon size={16} />,
        desc: "Card binders",
      },
      {
        label: "Damage Counters",
        href: "/shop?cat=damage_counter",
        icon: <Wrench size={16} />,
        desc: "Counters & tokens",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/bazaar",
        icon: <Users size={16} />,
        desc: "Trade & swap cards",
      },
      {
        label: "Guess Game",
        href: "/game",
        icon: <Gamepad2 size={16} />,
        desc: "Guess the Pokémon, earn points",
      },
      {
        label: "Tournaments",
        href: "/tournaments",
...
export default function Navbar() {
  ...
  return (
    <>
      {/* ─── Top Bar ─────────────────────────────────────────────────────────── */}
      <div
        style={{ background: "oklch(0.54 0.25 293)" }}
        className="text-white text-xs py-1.5 hidden md:block"
      >
        <div className="container flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 opacity-80">
            ...
            <Link href="/sell" className="hover:opacity-100 transition-opacity">
              Start Selling
            </Link>
            <Link
              href="/game"
            ...
            >
              Guess Game
              <span className="text-[9px] font-black bg-[#F5B301] text-black rounded-full px-1.5 py-px leading-tight">
                NEW
              </span>
            </Link>
            <Link
      ...
      >
        <div className="container">
          <div className="flex items-center gap-4 h-16">
            ...
            <Link
              href="/shop"
              className="hidden md:flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-semibold text-white shrink-0"
              style={{ background: "oklch(0.54 0.25 293)" }}
            >
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              {isAuthenticated ? (
                <>
                  ...
                  <div className="relative hidden sm:block">
                    ...
                    >
                      ...
                      {(unreadCount ?? 0) > 0 && (
                        <span
                          className="absolute -top-0.5 -right-0.5 min-w-4 h-4 px-0.5 text-[10px] font-bold text-white rounded-full flex items-center justify-center"
                  ...
                  <Link
                    href="/cart"
                    className="relative p-2 rounded-full hover:bg-gray-100 transition-colors hidden sm:flex"
                  >
                      ...
                      <div className="absolute right-0 top-full mt-2 w-52 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-50 animate-fade-in">
                        ...
                        {user?.role === "admin" && (
                          <>
                            ...
                            <Link
                              href="/admin/game"
                              className="flex items-center gap-3 px-4 py-2 text-sm font-bold text-violet-700 transition-colors hover:bg-violet-50"
                            >
                              <Trophy size={15} /> Weekly Prize Admin
                            </Link>
                          </>
                        )}
                ...
                <div className="flex items-center gap-2">
                  <a
                    href={getLoginUrl()}
                    className="text-sm font-semibold text-gray-700 hover:text-blue-600 transition-colors hidden sm:block px-3 py-1.5"
                  >
                    Sign In
                  </a>
                  <a
                    href={getLoginUrl()}
                    className="text-sm font-bold px-4 py-2 rounded-full text-white transition-all hover:opacity-90 active:scale-95"
                    style={{ background: "oklch(0.54 0.25 293)" }}
                  >
                    Register
                  </a>
        ...
        <div
          className="border-t border-gray-100 hidden md:block relative"
        ...
        >
              ...
              {navSections.map(section => (
                ...
                >
                  <span
                    style={{
                      color:
                        activeMenu === section.id ? "white" : section.color,
                    }}
                  >
                    {section.icon}
                  </span>
                  ...
                  <ChevronDown
                    size={13}
                    className={`transition-transform ${activeMenu === section.id ? "rotate-180" : ""}`}
                  />
                </button>
              ))}
            </nav>
          ...
          {activeMenu &&
            (() => {
              ...
              return (
                <div
                  className="absolute top-full left-0 right-0 bg-white shadow-2xl border-t z-50 animate-fade-in"
                  style={{
          ...
          <div className="md:hidden bg-white border-t border-gray-100 max-h-[80vh] overflow-y-auto animate-fade-in">
            {navSections.map(section => (
              ...
              >
                ...
                >
                  ...
                  <ChevronDown
                    size={14}
                    className={`text-gray-400 transition-transform ${activeMenu === section.id ? "rotate-180" : ""}`}
                  />
                </button>
                {activeMenu === section.id && (
                  <div className="bg-gray-50 py-1">
                    {section.items.map(item => (
                      <Link
                        key={item.href}
                        href={item.href}
                        className="flex items-center gap-3 px-6 py-2.5 text-sm text-gray-600 hover:text-blue-600 transition-colors"
                      >
                        <span className="text-gray-400">{item.icon}</span>
                        {item.label}
                      </Link>
            ...
            {!isAuthenticated && (
              <div className="p-4 flex gap-3">
                <a
                  href={getLoginUrl()}
                  className="flex-1 text-center py-2.5 text-sm font-semibold border border-gray-200 rounded-full text-gray-700 hover:bg-gray-50"
                >
                  Sign In
                </a>
                <a
                  href={getLoginUrl()}
                  className="flex-1 text-center py-2.5 text-sm font-bold rounded-full text-white"
                  style={{ background: "oklch(0.54 0.25 293)" }}
                >
                  Register
                </a>
