...
export default function GuessGame() {
  usePageMeta(
    "Guess the Pokémon",
    "Guess the hidden Pokémon, earn points and climb the TCG Arena leaderboard."
  );
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-3">
          <div
            ...
            style={{ background: "linear-gradient(135deg,#7C3AED,#FF2E9A)" }}
          >
            <HelpCircle size={22} />
          </div>
          <div>
            ...
            <p className="text-sm text-gray-500">
              Choose your challenge, follow the heat and build your leaderboard
              streak.
            </p>
          </div>
        </div>
      ...
      {!isAuthenticated ? (
        <div className="rounded-2xl border bg-white p-10 text-center max-w-lg mx-auto">
          ...
          <p className="text-sm text-gray-500 mb-5">
            Your points are saved to your account and rank you on the arena
            leaderboard.
          </p>
          <Link href="/login">
            <Button
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            {!round || round.status !== "active" ? (
              <div className="rounded-2xl border bg-white p-5 sm:p-8 text-center">
                <Sparkles size={40} className="mx-auto mb-3 text-violet-500" />
                <h2 className="text-xl font-bold mb-1">
                  Choose your difficulty
                </h2>
                <p className="text-sm text-gray-500 mb-6">
                  Harder modes offer fewer guesses and significantly more
                  points.
                </p>
                  ...
                  {(
                    ...
                    return (
                      <button
                        ...
                        className="rounded-2xl border-2 p-4 transition-all hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2"
                        style={{
                          borderColor: selected ? mode.accent : "#e5e7eb",
                          background: selected ? mode.soft : "#fff",
                          boxShadow: selected
                            ? `0 10px 28px ${mode.border}80`
                            : "none",
                        }}
                      >
                ...
                <Button
                  ...
                  className="rounded-full font-bold px-8 text-white"
              ...
              <>
                ...
                <div className="rounded-2xl border bg-white p-4 mb-4">
                  <div className="flex items-center justify-between gap-3 text-xs font-bold mb-2">
                    ...
                    >
                      <span className="inline-flex">{activeMode.icon}</span>{" "}
                  ...
                  <div className="flex justify-between mt-2 text-[11px] text-gray-500">
                    ...
                    <span>
                      <strong style={{ color: activeMode.accent }}>
                        {pointsPerAttempt} pts
                      </strong>{" "}
                      per remaining guess
                    </span>
                  </div>
            ...
            <div className="rounded-2xl border bg-white p-5">
              ...
              <div className="space-y-1.5">
                {(boardQ.data ?? []).map((row: any, i: number) => (
                  ...
                  >
                    <span
                      className={`w-6 text-center font-black text-sm ${i === 0 ? "text-amber-500" : i === 1 ? "text-gray-400" : i === 2 ? "text-orange-400" : "text-gray-300"}`}
                    >
                      {i + 1}
                    </span>
                    {row.avatarUrl ? (
                      ...
                      <div className="w-7 h-7 rounded-full bg-violet-100 flex items-center justify-center text-[11px] font-bold text-violet-600">
